...
let current_users = ['Ali', 'Babar', 'Bilal', 'Fayaz', 'Dawood'];
let new_users = ['Ali', 'Babar', 'Fareed', 'Ahmed', 'Kamran'];
function Usernames(currentUsers, newUsers) {
    for (let newUser of newUsers) {
        let isUsernameTaken = currentUsers.some((currentUsername) => currentUsername.toLowerCase() === newUser.toLowerCase());
        if (isUsernameTaken) {
